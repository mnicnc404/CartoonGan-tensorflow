...
Project pages with online demo:

| Language | Project / Demo page |
|----------|---------------------|
| English | [Generate Anime using CartoonGAN and TensorFlow 2.0](http://localhost:8000/drafts/generate-anime-using-cartoongan-and-tensorflow2-en.html) |
| 中文（Chinese）|[用 CartoonGAN 及 TensorFlow 2 畫動漫](http://localhost:8000/drafts/generate-anime-using-cartoongan-and-tensorflow2.html) | 
...
- visiting the [CartoonGAN web demo](http://localhost:8000/drafts/generate-anime-using-cartoongan-and-tensorflow2-en.html) 
...
## [Cartoonize using TensorFlow.js](http://localhost:8000/drafts/generate-anime-using-cartoongan-and-tensorflow2-en.html)
...
- [TODO] showcase Tensorboard integration

For further details, we recommend you to read code in [train.py](train.py).

## Gallery of Generated Animes

If you want to view more animes generated by CartoonGAN, please visit the blog article with language you prefer:
